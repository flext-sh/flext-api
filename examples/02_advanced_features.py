...
def example_advanced_queries():
    ...
    # Especializar para administradores
    admin_query = base_query.equals("role", "admin").sort_desc("last_login").build()
    print(f"Admin query: {len(admin_query['filters'])} filters")
