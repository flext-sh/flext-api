...
def traditional_auth_endpoint() -> FastAPI:
    ...
    async def protected_endpoint(request: Request):
        try:
            ...
            # Manual role check
            required_roles = ["REDACTED_LDAP_BIND_PASSWORD", "moderator"]
...
def flext_api_auth_endpoint() -> FastAPI:
    ...
    @flext_api_handle_errors()
    # @flext_api_authorize_roles("REDACTED_LDAP_BIND_PASSWORD", "moderator")  # TODO: Implement authorization
    async def REDACTED_LDAP_BIND_PASSWORD_endpoint(request: Request):
        # Authentication + authorization handled automatically
        return flext_api_success_response(
            data={"REDACTED_LDAP_BIND_PASSWORD_action": "completed"}, message="Admin operation successful",
        )
