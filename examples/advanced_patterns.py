...
def create_enterprise_api() -> object:
    ...
    config = FlextAPIConfig(
        ...
        cors_origins=["https://app.company.com", "https://REDACTED_LDAP_BIND_PASSWORD.company.com"],
...
@authorize_roles("data_analyst", "REDACTED_LDAP_BIND_PASSWORD")  # Role-based access
