...
class TestMicroservicesIntegration:
    ...
    def test_real_world_service_configuration(self) -> None:
        ...
        services = [
            ("auth-service", "internal.invalid.com", 8080, "https", "v1"),
            ("user-service", "internal.invalid.com", 8081, "https", "v2"),
            ("inventory-service", "internal.invalid.com", 8082, "https", "v1"),
            ("notification-service", "internal.invalid.com", 8083, "https", "v1"),
        ]
