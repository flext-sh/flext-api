...
class TestFlextApiUtilitiesComprehensive:
    ...
    def test_validate_http_request_config_failures(self) -> None:
        ...
        invalid_config = HttpRequestConfig(url="", method="GET")
        ...
        # Invalid HTTP method
        invalid_method_config = HttpRequestConfig(
    ...
    def test_validate_http_error_config_failures(self) -> None:
        ...
        invalid_config = HttpErrorConfig(message="Error", status_code=50)
        result = FlextApiUtilities.validate_config(invalid_config)
        FlextMatchers.assert_result_failure(result)
        assert result.error is not None
        ...
        invalid_high_config = HttpErrorConfig(message="Error", status_code=700)
    ...
    def test_url_component_validation(self) -> None:
        ...
        # too long
        long_path = "a" * FlextApiConstants.HttpValidation.MAX__LENGTH
    ...
    def test_edge_cases_and_error_handling(self) -> None:
        ...
        FlextMatchers.assert_result_failure(status_result)
        ...
        response = cast("dict[str, object]", pagination_result.value)
