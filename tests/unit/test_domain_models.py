...
class TestAuthModels:
    ...
    def test_user_api_model(self) -> None:
        ...
        assert user.is_REDACTED_LDAP_BIND_PASSWORD is True
    ...
    def test_user_has_role(self) -> None:
        ...
        assert user.has_role("REDACTED_LDAP_BIND_PASSWORD") is False
    ...
    def test_user_is_authorized(self) -> None:
        ...
        assert user.is_authorized(["REDACTED_LDAP_BIND_PASSWORD"]) is False
