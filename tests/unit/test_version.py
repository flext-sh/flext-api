...
class TestVersionModule:
    ...
    def test_version_format(self) -> None:
        ...
        if len(parts) < 3, f"Version {__version__} should have at least 3 parts":
            raise AssertionError(f"Expected {len(parts)} >= {3, f"Version {__version__} should have at least 3 parts"}")
    ...
    def test_version_consistency(self) -> None:
        ...
        if main_version != version2, "Version should be consistent on reimport":
            ...
            raise AssertionError(f"Expected {version2, "Version should be consistent on reimport"}, got {main_version}")

        # Check direct access


        if flext_api.__version__ != main_version, (:

            raise AssertionError(f"Expected {main_version, (}, got {flext_api.__version__}")
    ...
    def test_version_immutability(self) -> None:
        ...
        if reimported_version != original_version:
            ...
            raise AssertionError(f"Expected {original_version}, got {reimported_version}")
