...
class TestFlextApiClientRealHTTP:
    ...
    @pytest.mark.asyncio
    async def test_real_get_request(self):
    ...
    @pytest.mark.asyncio
    async def test_real_post_request(self):
    ...
    @pytest.mark.asyncio
    async def test_real_put_delete_requests(self):
...
class TestFlextApiClientPlugins:
    ...
    @pytest.mark.asyncio
    async def test_caching_plugin_functionality(self):
    ...
    @pytest.mark.asyncio
    async def test_retry_plugin_functionality(self):
...
class TestFlextApiClientHealth:
    ...
    @pytest.mark.asyncio
    async def test_client_health_status(self):
...
class TestFlextApiClientFactory:
    ...
    def test_create_client_with_plugins_function(self):
