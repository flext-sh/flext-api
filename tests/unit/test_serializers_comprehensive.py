...
class TestJSONSerializer:
    ...
    def test_serialize_nested_structure(self) -> None:
        ...
        assert b'"REDACTED_LDAP_BIND_PASSWORD"' in result
    ...
    def test_deserialize_nested_structure(self) -> None:
        ...
        json_bytes = (
            b'{"user": {"id": 123, "name": "John", "roles": ["REDACTED_LDAP_BIND_PASSWORD", "user"]}}'
        )
        result = serializer.deserialize(json_bytes)
        ...
        assert "REDACTED_LDAP_BIND_PASSWORD" in result["user"]["roles"]
