...
from flext_api import FlextApi, FlextApiConfig, FlextApiConstants
...
class TestFlextApiInitMethods:
    ...
    def test_create_config_with_kwargs(self) -> None:
        ...
        with patch('flext_api.FlextApi.Config') as mock_config_class:
            ...
            mock_config_class.get_or_create_shared_instance.return_value = mock_config_instance
    ...
    def test_create_config_error_handling(self) -> None:
        ...
        with patch('flext_api.FlextApi.Config') as mock_config_class:
            mock_config_class.get_or_create_shared_instance.side_effect = Exception("Config creation failed")
