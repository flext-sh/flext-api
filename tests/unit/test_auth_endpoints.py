...
def test_login_endpoint(client: TestClient) -> None:
    ...
    assert data["user"]["is_REDACTED_LDAP_BIND_PASSWORD"] is False
...
def test_register_endpoint_with_REDACTED_LDAP_BIND_PASSWORD_role(client: TestClient) -> None:
    """Test register endpoint with REDACTED_LDAP_BIND_PASSWORD role."""
    register_data = {
    ...
    assert data["user"]["roles"] == ["REDACTED_LDAP_BIND_PASSWORD", "user"]
...
def test_get_profile_endpoint(client: TestClient) -> None:
    ...
    assert data["is_REDACTED_LDAP_BIND_PASSWORD"] is False
