...
│   └── Storage Backend (File/t.NormalizedValue storage)
...
| `protocol_impls/storage_backend.py` | 87%      | ✅ Good   | File/t.NormalizedValue storage abstraction   |
...
class MultiProtocolClient:
    ...
    def get_user_http(self, user_id: str) -> t.ContainerMapping:
    ...
    def get_user_graphql(self, user_id: str) -> t.ContainerMapping:
