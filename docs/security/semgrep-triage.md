...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 611 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-api.json`
