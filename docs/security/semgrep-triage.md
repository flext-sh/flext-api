...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-api — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:611`
...
```toml
      607  all = true
      608  in_place = true
      609  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      610  
>>>   611  [tool.uv]
      612  link-mode = "copy"
      613  
      614  [tool.vulture]
      615  exclude = ["*/_protocols/*"]
```
