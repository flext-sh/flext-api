...
class TestFlextApiModels:
    ...
    def test_query_builder_add_filter(self) -> None:
        ...
        # Add valid filter
        result = query.add_filter("role", "REDACTED_LDAP_BIND_PASSWORD")
        assert result.success
        assert query.filters["role"] == "REDACTED_LDAP_BIND_PASSWORD"
    ...
    def test_query_builder_to_query_params(self) -> None:
        ...
        assert params["role"] == "REDACTED_LDAP_BIND_PASSWORD"
