...
class StorageBackendProtocol(Protocol):
    ...
    def keys(self) -> FlextResult[list[StorageKey]]:
        """Get all keys."""
        ...
...
class ConnectionManagerProtocol(Protocol):
    ...
    def is_healthy(self) -> FlextResult[bool]:
...
class CacheProtocol(Protocol):
    ...
    def set(self, key: str, value: object, ttl: int | None = None) -> FlextResult[bool]:
...
class RequestValidatorProtocol(Protocol):
    ...
    def validate_request(self, request_data: RequestData) -> FlextResult[RequestData]:
...
class AuthenticationProviderProtocol(Protocol):
    ...
    def get_auth_headers(self) -> FlextResult[HttpHeaders]:
    ...
    def refresh_auth(self) -> FlextResult[bool]:
...
class MetricsCollectorProtocol(Protocol):
    ...
    def record_error(self, error: Exception, context: JsonObject) -> FlextResult[bool]:
        """Record error metrics."""
        ...

    def get_metrics(self) -> FlextResult[JsonObject]:
...
class MiddlewareProtocol(Protocol):
    ...
    async def process_request(self, request: RequestData) -> FlextResult[RequestData]:
...
class ConfigurationProviderProtocol(Protocol):
    ...
    def reload_config(self) -> FlextResult[bool]:
