...
class FlextApiModelsWebhook:
    ...
    class State(m.FlexibleInternalModel):
        ...
        event_queue: MutableSequence[FlextApiModelsWebhook.Event] = u.Field(
            default_factory=list, description="Main event queue"
        )
        retry_queue: MutableSequence[FlextApiModelsWebhook.Event] = u.Field(
            default_factory=list, description="Retry event queue"
        )
        deliveries: MutableMapping[str, FlextApiModelsWebhook.Delivery] = u.Field(
