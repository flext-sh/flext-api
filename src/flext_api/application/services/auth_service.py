            ...
            return ServiceResult.ok(
                {
                    ...
                    "user": UserAPI(
                        ...
                        is_REDACTED_LDAP_BIND_PASSWORD=user_data.get("is_REDACTED_LDAP_BIND_PASSWORD", False),
                    ),
                    "session_id": session_data["session_id"],
    ...
    async def validate_token(self, token: str) -> ServiceResult[UserAPI]:
        ...
        try:
            ...
            user = UserAPI(
                ...
                is_REDACTED_LDAP_BIND_PASSWORD=token_data.get("is_REDACTED_LDAP_BIND_PASSWORD", False),
            )
