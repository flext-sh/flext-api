...
def build_query_dict(
    ...
    """
    query = build_query(
        filters=filters, sorts=sorts, page=page, page_size=page_size, search=search, fields=fields,
    )
...
try:
    ...
    warnings.warn(
        f"Failed to import core API components: {e}", ImportWarning, stacklevel=2,
    )
...
__all__: list[str] = [
    "__version__", "__version_info__", "FlextResult", "get_logger", "FlextApiSettings",
    "create_api_settings", "load_configuration", "validate_configuration", "HttpMethod", "HttpStatus",
    "ClientProtocol", "ClientStatus", "RequestState", "ResponseState", "TokenType", "OperationType",
    "URL", "HttpHeader", "BearerToken", "ClientConfig", "QueryConfig", "PaginationInfo", "ApiRequest",
    "ApiResponse", "ApiEndpoint", "ApiSession", "RequestDto", "ResponseDto", "ApiErrorContext",
    "QueryBuilder", "ResponseBuilder", "DEFAULT_TIMEOUT", "DEFAULT_PAGE_SIZE", "DEFAULT_MAX_RETRIES",
    "APITypes", "APITypesCompat", "get_api_types", "TData", "T_Payload", "T_Request", "T_Response",
    "FlextAPIFieldCore", "FlextAPIFields", "api_key_field", "bearer_token_field", "endpoint_path_field",
    "http_method_field", "pipeline_config_field", "plugin_config_field", "response_format_field",
    "user_role_field", "FlextApiClient", "FlextApiClientConfig", "FlextApiClientRequest",
    "FlextApiClientResponse", "FlextApiClientProtocol", "FlextApiClientMethod", "FlextApiClientStatus",
    "FlextApiBuilder", "FlextApiQueryBuilder", "FlextApiResponseBuilder", "PaginatedResponseBuilder",
    "FlextApiQuery", "FlextApiResponse", "FlextApiOperation", "ResponseConfig", "PaginationConfig",
    "FlextApiPlugin", "FlextApiCachingPlugin", "FlextApiRetryPlugin", "FlextApiError",
    "FlextApiValidationError", "FlextApiAuthenticationError", "FlextApiAuthorizationError",
    "FlextApiConfigurationError", "FlextApiConnectionError", "FlextApiProcessingError",
    "FlextApiTimeoutError", "FlextApiRequestError", "FlextApiResponseError", "FlextApiStorageError",
    "FlextApiBuilderError", "FlextApiRateLimitError", "FlextApiNotFoundError", "create_error_response",
    "map_http_status_to_exception", "FlextApiStorage", "StorageConfig", "StorageBackend",
    "MemoryStorageBackend", "FileStorageBackend", "MemoryCache", "FlextApiPluginProtocol",
    "FlextApiConnectionPoolProtocol", "FlextApiQueryBuilderProtocol", "FlextApiResponseBuilderProtocol",
    "FlextApiServiceProtocol", "FlextApiAuthProtocol", "FlextApiAuthorizationProtocol",
    "FlextApiRepositoryProtocol", "FlextApiCacheProtocol", "FlextApiMiddlewareProtocol",
    "FlextApiRateLimitProtocol", "FlextApiHandlerProtocol", "FlextApiValidatorProtocol",
    "FlextApiStreamProtocol", "FlextApiWebSocketProtocol", "FlextApiMetricsProtocol",
    "FlextApiHealthCheckProtocol", "create_flext_api_app", "create_flext_api_app_with_settings",
    "run_development_server", "run_production_server", "app", "create_client", "create_api_client",
    "create_api_builder", "create_storage", "create_api_storage", "create_memory_storage",
    "create_file_storage", "build_query", "build_query_dict", "build_success_response",
    "build_error_response", "build_paginated_response", "create_client_with_plugins",
    "FLEXT_API_VERSION", "FLEXT_API_TIMEOUT", "FLEXT_API_MAX_RETRIES", "FLEXT_API_CACHE_TTL",
    "annotations",
]
