...
async def register(register_data: RegisterRequest) -> RegisterResponse:
    ...
    try:
        ...
        _raise_internal_error(
            "User registration system error - administrators have been notified",
        )
...
async def create_pipeline(
    ...
    try:
        ...
        _raise_internal_error(
            "Pipeline creation system error - administrators have been notified",
        )
...
"Access denied: insufficient permissions")
        ...
        _raise_internal_error(
            "Pipeline retrieval system error - administrators have been notified",
        )
...
"Pipeline update succeeded but retrieval failed")
        ...
        _raise_internal_error(
            "Pipeline update system error - administrators have been notified",
        )
...
"Pipeline deletion failed - pipeline may have been deleted by another operation")
        ...
        _raise_internal_error(
            "Pipeline deletion system error - administrators have been notified",
        )
...
"Pipeline execution update succeeded but retrieval failed")
        ...
        _raise_internal_error(
            "Pipeline execution system error - administrators have been notified",
        )
...
async def list_pipelines(
    ...
    try:
        ...
        _raise_internal_error(
            "Pipeline listing system error - administrators have been notified",
        )
...
"Plugin configuration must be a valid dictionary")
        ...
        _raise_internal_error(
            "Plugin configuration system error - administrators have been notified",
        )
