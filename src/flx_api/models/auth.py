...
class UserAPI(BaseModel):
    ...
    --------
        ...
        ```python
        user = UserAPI(username="REDACTED_LDAP_BIND_PASSWORD", roles=["REDACTED_LDAP_BIND_PASSWORD"])
        result = user.is_authorized(["REDACTED_LDAP_BIND_PASSWORD"])
        ```
    ...
    def has_role(self, role: str) -> bool:
        ...
        return role in self.roles or "REDACTED_LDAP_BIND_PASSWORD" in self.roles
