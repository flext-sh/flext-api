...
class TransactionContext[V]:
    transaction_id: str = ...
    operations: list[tuple[str, str, _V]] = ...
    started_at: float = ...
    is_active: bool = ...

class StorageBackendInterface[K, V](ABC):
    @abstractmethod
    async def get(self, key: _K) -> FlextResult[_V | None]: ...
    @abstractmethod
    async def set(
        self, key: _K, value: _V, ttl_seconds: int | None = None
    ) -> FlextResult[None]: ...
    @abstractmethod
    async def delete(self, key: _K) -> FlextResult[bool]: ...
    @abstractmethod
    async def exists(self, key: _K) -> FlextResult[bool]: ...
    @abstractmethod
    async def keys(self, pattern: str | None = None) -> FlextResult[list[_K]]: ...
    @abstractmethod
